...
class TestLogin(BaseClass):
    ...
    def test_verify_title_page(self):
        ...
        try:
            ...
            img_file_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'Screenshots','test_verify_title_page.jpg'))
    ...
    def test_verify_login_elements_displayed(self):
        try:
            ...
            img_file_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'Screenshots', 'test_verify_login_elements_displayed.jpg'))
            self.driver.save_screenshot(img_file_path)
            self.logger.exception("******** Exception occurred in test_verify_login_elements_displayed ********",exc_info=True)
            assert False
    ...
    def test_verify_login_elements_text(self):
        try:
            ...
            img_file_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'Screenshots', 'test_verify_login_elements_text.jpg'))
            self.driver.save_screenshot(img_file_path)
            self.logger.exception("******** Exception occurred in test_verify_login_elements_text ********",exc_info=True)
            assert False
    ...
    def test_verify_login_with_invalid_credentials(self):
        try:
            ...
            img_file_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'Screenshots', 'test_verify_login_with_invalid_credentials.jpg'))
            self.driver.save_screenshot(img_file_path)
            self.logger.exception("******** Exception occurred in test_verify_login_with_invalid_credentials ********",exc_info=True)
            assert False
